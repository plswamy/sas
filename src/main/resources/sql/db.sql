...
INSERT INTO `users` ( `created_at`, `created_by`, `updated_at`, `updated_by`, `entity_status`, `version`, `email`, `password_hash`, `user_name`)
VALUES
  (now(), 1, now(), NULL, 'ACTIVE', 1, 'test@test.com', 'Password1234', 'test'),
  (now(), 1, now(), NULL, 'ACTIVE', 1, 'test@test.com', 'Password1234', 'admin');
