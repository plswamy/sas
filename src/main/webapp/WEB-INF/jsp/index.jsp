  <!DOCTYPE html>
    ...
    <body>
    <form name="gsatForm" method="post" action="survey" onsubmit="javascript:return WebForm_OnSubmit();"
    id="gsatForm">
    <div>
    ...
    console.log("======================== success : " +
    $("#ctl00_ContentPlaceHolder1_tbxEmail").val());
    var userInfo = {
  ...
  %>
    ...
    <h3><%= regFormHeaderMsg %></h3>
    <p id="validateMsg" style="display: none; margin: 1.4em 0; color:
    #ba2222;"><%= regFormHeaderErrorMsg %></p>
    <table cellpadding="0" cellspacing="0" border="0">
    <tbody>
    <tr>
    <td class="label">
    <label for="ctl00_ContentPlaceHolder1_tbxFirstName"
    id="ctl00_ContentPlaceHolder1_lblFirstName">First Name*</label>
    </td>
    <td class="field spacer">
    <input name="ctl00$ContentPlaceHolder1$tbxFirstName" type="text" maxlength="40"
    id="ctl00_ContentPlaceHolder1_tbxFirstName" value="Rahul">
    <span id="ctl00_ContentPlaceHolder1_reqFirstName" style="color:Red;display:none;"></span>
    </td>
    <td class="label">
    <label for="ctl00_ContentPlaceHolder1_tbxLastName"
    id="ctl00_ContentPlaceHolder1_lblLastName">Last Name*</label>
    </td>
    <td class="field">
    <input name="ctl00$ContentPlaceHolder1$tbxLastName" type="text" maxlength="40"
    id="ctl00_ContentPlaceHolder1_tbxLastName" value="Dravid">
    ...
    id="ctl00_ContentPlaceHolder1_lblJobTitle">Job Title*</label>
    </td>
    <td class="field spacer">
    <input name="ctl00$ContentPlaceHolder1$tbxJobTitle" type="text" maxlength="100"
    ...
    id="ctl00_ContentPlaceHolder1_lblEmail">Email*</label>
    </td>
    <td class="field">
    <input name="ctl00$ContentPlaceHolder1$tbxEmail" type="text" maxlength="100"
    ...
    id="ctl00_ContentPlaceHolder1_lblCompany">Company*</label>
    </td>
    <td class="field spacer">
    <input name="ctl00$ContentPlaceHolder1$tbxCompany" type="text" maxlength="100"
    id="ctl00_ContentPlaceHolder1_tbxCompany" value="BCCI">
    <span id="ctl00_ContentPlaceHolder1_Requiredfieldvalidator4"
    style="color:Red;display:none;"></span>
    </td>
    <td class="label">
    <label for="ctl00_ContentPlaceHolder1_ddlBusinessIndustry"
    id="ctl00_ContentPlaceHolder1_lblBusinessIndustry">Business
    Industry*</label>
    </td>
    <td class="field">
    <select name="ctl00$ContentPlaceHolder1$ddlBusinessIndustry"
    ...
    <tr>
    <td class="label pad-top">
    <label for="ctl00_ContentPlaceHolder1_ddlCountry"
    id="ctl00_ContentPlaceHolder1_lblCountry">Country*</label>
    </td>
    <td class="field spacer pad-top">
    <select name="ctl00$ContentPlaceHolder1$ddlCountry" value="India"
    ...
    id="ctl00_ContentPlaceHolder1_lblState">State*</label>
    </td>
    <td class="field pad-top">
    <select name="ctl00$ContentPlaceHolder1$ddlState"
    id="ctl00_ContentPlaceHolder1_ddlState">
    <option value="">Choose country first...</option>

    </select>
    <span id="ctl00_ContentPlaceHolder1_Requiredfieldvalidator7"
    style="color:Red;display:none;"></span>
    ...
    <tr>
    <td class="pad-top" colspan="2" style="vertical-align: top;"><span
    class="required">*Required fields</span></td>
    <td class="pad-top" colspan="2" align="right">
    <a id="ctl00_ContentPlaceHolder1_btnRegister" class="btn btn-green" href="javascript:WebForm_DoPostBackWithOptions(new
    ...
    <img src="support/img/strapline.png"
    alt="Worldwide reach. Human touch.">
    </div>
    </div>
