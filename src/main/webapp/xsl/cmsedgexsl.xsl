...
<!--Body starts-->   
     ...
     <fo:flow flow-name="xsl-region-body">
		...
		<fo:block text-align="start" line-height="1em + 2pt">
            ...
            <fo:block text-align="start" line-height="1em + 2pt">
				<fo:table  table-layout="fixed" space-before="0.8cm" width="300%" height="4cm"   padding="9mm"    >
			...
			<fo:block text-align="start" line-height="1em + 2pt">
				<fo:table  table-layout="fixed" width="300%" space-before="0.5cm"  border-top-style="solid" border-top-width="2pt"  padding="-2mm" >
						<fo:table-column column-width="10.5cm"/>
						<fo:table-column column-width="10.5cm"/>
						<fo:table-column column-width="10.5cm"/> 
						<fo:table-column column-width="12.35cm"/>
