...
public class SASConstants {
	...
	public static final String EMAIL = "registrationinfo.f4";
	public static final String FIRST_NAME = "registrationinfo.f1";
	public static final String LAST_NAME = "registrationinfo.f2";
